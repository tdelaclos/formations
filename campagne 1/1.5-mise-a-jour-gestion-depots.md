...
Utilisez `man dnf`, `man rpm` et la documentation de la version AlmaLinux installée. La campagne 10 reprendra la chaîne du côté producteur : construction, dépendances, configuration, signature, dépôt privé et packaging de Sentinel.
