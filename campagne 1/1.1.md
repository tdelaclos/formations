...
- Un serveur est sécurisé **avant** d'héberger une application.
- La réduction de la surface d'attaque est le premier levier de sécurité.
- Les protections doivent être **complémentaires** et non concurrentes.
- Une installation minimale constitue la meilleure base pour construire un serveur de production.
- La sécurité est un cycle d'amélioration continue.
