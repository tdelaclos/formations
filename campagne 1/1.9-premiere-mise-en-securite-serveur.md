...
Le chapitre **Première mise en sécurité du serveur** établit une brique du socle de sécurité Sentinel.
...
← [1.8 — `sudo` et principe du moindre privilège](1.8-sudo-moindre-privilege.md) · [1.10 — Création du laboratoire Sentinel](1.10-creation-laboratoire-sentinel.md) →
