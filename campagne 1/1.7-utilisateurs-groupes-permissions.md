...
← [1.6 — Architecture des systèmes de fichiers](1.6-architecture-systemes-fichiers.md) · [1.8 — `sudo` et principe du moindre privilège](1.8-sudo-moindre-privilege.md) →
