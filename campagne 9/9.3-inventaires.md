...
Dans le prochain chapitre, nous écrirons notre **premier véritable playbook Ansible** et découvrirons sa structure complète, ligne par ligne.
...
← [9.2 — Architecture d'Ansible](9.2-composants-ansible.md) · [9.4 — Premiers playbooks](9.4-premiers-playbooks.md) →
