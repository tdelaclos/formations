# Chapitre 9.1 — Architecture Ansible
...
- expliquer les notions essentielles liées à **Architecture Ansible** ;
...
Ce chapitre fournit le modèle mental et les pratiques nécessaires pour aborder **Architecture Ansible** dans un socle AlmaLinux sécurisé et reproductible.
...
Dans la prochaine partie, nous découvrirons les composants fondamentaux d'Ansible : le **nœud de contrôle**, les **nœuds administrés**, les **inventaires** et les **modules**.

## Synthèse

Le chapitre **Architecture Ansible** établit une brique du socle de sécurité Sentinel.
...
[9.2 — Architecture d'Ansible](9.2-composants-ansible.md) →
