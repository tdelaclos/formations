...
- expliquer les notions essentielles liées à **Mission : administrer Sentinel en sécurité** ;
...
Ce chapitre fournit le modèle mental et les pratiques nécessaires pour aborder **Mission : administrer Sentinel en sécurité** dans un socle AlmaLinux sécurisé et reproductible.
...
Le chapitre **Mission : administrer Sentinel en sécurité** établit une brique du socle de sécurité Sentinel.
