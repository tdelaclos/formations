...
```mermaid
flowchart LR
    Process["Processus : sentinel_t"] --> Policy{"Politique SELinux"}
    File["Fichier : sentinel_conf_t"] --> Policy
    Policy -->|allow| Access["Opération autorisée"]
    Policy -->|aucune règle| AVC["Refus AVC"]
```
...
← [6.1 — Pourquoi SELinux existe](6.1-pourquoi-selinux-existe.md) · [6.3 — Les politiques SELinux](6.3-politiques-selinux.md) →
