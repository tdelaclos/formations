# Chapitre 9.2 — Architecture d'Ansible
...
- expliquer les notions essentielles liées à **Architecture d'Ansible** ;
...
Ce chapitre fournit le modèle mental et les pratiques nécessaires pour aborder **Architecture d'Ansible** dans un socle AlmaLinux sécurisé et reproductible.
...
Dans les chapitres suivants, nous verrons comment Ansible fournit justement des mécanismes (blocs, rôles, handlers, tags...) permettant de découper naturellement un déploiement en étapes simples, indépendantes et facilement maintenables.

---

← [9.1 — Architecture Ansible](9.1-architecture-ansible.md) · [9.3 — Inventaires](9.3-inventaires.md) →
