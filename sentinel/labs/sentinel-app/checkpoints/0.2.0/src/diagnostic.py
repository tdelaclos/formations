"""Diagnostic local hérité de la campagne 1."""
...
def collect_status() -> dict[str, str]:
    """Collecte uniquement des informations locales non sensibles."""
...
def render_status(status: dict[str, str], output_format: str) -> str:
    """Conserve les contrats texte et JSON acquis en campagne 1."""
