"""Tests du checkpoint Sentinel 0.4.0."""
...
class SentinelTests(unittest.TestCase):
    ...
    def test_health_and_readiness_are_distinct(self) -> None:
        self.assertEqual(self.fetch("/health")[1]["status"], "ok")
    ...
    def test_sd_notify_sends_datagram(self) -> None:
        ...
        # Le test cible désormais le module propriétaire de l'intégration systemd.
