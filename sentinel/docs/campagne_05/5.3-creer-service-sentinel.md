...
flowchart TD
    N0["Crash"]
    N1["systemd détecte l'échec"]
    N2["Redémarrage automatique"]
    N0 --> N1
    N1 --> N2
```
...
flowchart TD
    N0["Modification"]
    N1["Reload"]
    N2["Configuration appliquée"]
    N3["Connexions conservées"]
    N0 --> N1
    N1 --> N2
    N2 --> N3
```
...
```mermaid
flowchart TD
    N0["AlmaLinux<br/>systemd (PID 1)"]
    N1["sentinel.service"]
    N2["/opt/sentinel/bin/sentinel"]
    N3["Utilisateur sentinel"]
    N4["Journald / Cgroups"]
    N0 --> N1
    N1 --> N2
    N2 --> N3
...
![Récapitulatif visuel du chapitre 5.3](media/recap-5.3.png)
