...
1. message Rsyslog reçu sur le collecteur ;
2. collecteur arrêté puis reprise de la file ;
3. modification de `sentinel.conf` attribuée par Audit ;
4. dérive détectée par AIDE puis restaurée ;
5. endpoint Sentinel indisponible puis alerte firing ;
6. notification routée avec runbook ;
7. dashboard montrant impact, ressources et contrôle de sécurité ;
8. retour au vert sans silence résiduel.
