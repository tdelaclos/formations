# Chapitre 9.9 — Industrialiser le laboratoire
...
Ce chapitre fournit le modèle mental et les pratiques nécessaires pour aborder **Industrialiser le laboratoire** dans un socle AlmaLinux sécurisé et reproductible.
...
Dans un projet réel, cette politique doit être imposée par la revue et la CI : Ansible Vault ou un gestionnaire de secrets protège les valeurs sensibles avant tout partage du dépôt.
...
Le chapitre **Industrialiser le laboratoire** établit une brique du socle de sécurité Sentinel.
...
Le chapitre suivant ne sera plus consacré à l'apprentissage de nouvelles briques techniques.
...
← [9.8 — Intégrer Sentinel à FreeIPA](9.8-integrer-sentinel-freeipa.md) · [9.10 — Mission : déployer l'infrastructure Sentinel](9.10-mission-deploiement-sentinel.md) →
