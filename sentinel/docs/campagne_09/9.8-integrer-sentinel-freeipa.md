# Chapitre 9.8 — Intégrer Sentinel à FreeIPA
...
Ce chapitre fournit le modèle mental et les pratiques nécessaires pour aborder **Intégrer Sentinel à FreeIPA** dans un socle AlmaLinux sécurisé et reproductible.
...
Le chapitre **Intégrer Sentinel à FreeIPA** établit une brique du socle de sécurité Sentinel.
...
← [9.7 — Déployer Sentinel avec Ansible](9.7-deployer-sentinel-ansible.md) · [9.9 — Industrialiser le laboratoire](9.9-industrialiser-laboratoire.md) →
