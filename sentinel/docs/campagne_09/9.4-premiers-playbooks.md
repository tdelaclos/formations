...
C'est précisément ce qui permettra de construire un déploiement unique capable de s'adapter automatiquement à toute notre infrastructure Sentinel.
...
Le chapitre suivant sépare les valeurs propres à chaque environnement et génère les configurations avec les variables et les templates Jinja2.
